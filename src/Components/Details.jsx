  ...
  return products ? ( 
    <div className='w-[70%] h-full justify-between items-center m-auto p-[10%] flex  '>
        ...
        <div className='content w-[50%] '>
          ...
          <Link className='py-2 px-5 mr-[5%] rounded-md border border-blue-200 text-blue-400' >Edit</Link>
          <Link className='py-2 px-5 border rounded-md  border-red-200 text-red-400'>Delete</Link>  
